...
def plot_mean_std_bar_chart(means, stds, dataset, strat, x_label='Class', y_label='Number of Hard Samples'):
    ...
    plt.tight_layout()
    plt.savefig(f'Figures/Figure 8/{dataset}_{strat}_Experiment1.pdf')
